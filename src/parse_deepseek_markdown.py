...
class ChatExportProcessor:
    ...
    def process_export(self) -> dict[str, Any]:
        ...
        self.output_dir = (
            self.base_dir / f"deepseek_{self.export_path.stem}_{timestamp_str}_markdown"
        )
...
def main():
    ...
    Usage:
            python parse_deepseek_markdown.py                      # Uses config.json
            python parse_deepseek_markdown.py <path_to_export>     # Process specific file
    """
    from pathlib import Path
